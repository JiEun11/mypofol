...
module.exports = {
    ...
    skills: async (req, res, next) => {
      try {
         ...
         * 
         *  쟤 때문에 아래는 할 필요가 없음 req.account에 이 정보가 있음!!
         *  ejs 에서도 참조 가능!! 따라서 따로 세팅해 줄 필요가 없음
         * 
         *  아 참고로...
         *  /bella 여기에 다른 로그인 한 사용자가 접근할 수 있쟎어?
         *  로그인한 사용자랑 헷갈릴 수 있어
         *  /bella 의 접근하는 계정 정보는 account라 했음!!!
         * 
         *  디비가 바껴서 user와 profile은 분리 했음
         *  헷갈리니깐... 꼭 참고해서 바라~~
         * 
         */
